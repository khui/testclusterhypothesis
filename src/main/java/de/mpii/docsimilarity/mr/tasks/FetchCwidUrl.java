 ...
 * @author khui
 */
public class FetchCwidUrl extends Configured implements Tool {
    
    private static final Logger logger = Logger.getLogger(FetchCwidUrl.class);
    ...
    public int run(String[] args) throws Exception {
         ...
         */
        Job job = new Job(getConf(), FetchCwidUrl.class.getSimpleName() + " Fetch url for given cwid: " + colname);
        job.setJarByClass(FetchCwidUrl.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new FetchCwidUrl(), args);
