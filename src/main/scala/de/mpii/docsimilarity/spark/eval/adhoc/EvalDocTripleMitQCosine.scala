...
import de.mpii.docsimilarity.mr.utils.{GlobalConstants, IRScorer}
...
/**
  ...
  */
object EvalDocTripleMitQCosine {
  ...
  def main(args : Array[String]): Unit = {
    ...
    val conf: SparkConf = new SparkConf()
      .setAppName("Eval on doc triple similarity benchmark (query sensitive) " + expname)
        ...
        new Runnable{
          override def run(): Unit ={
            ...
            if (docvecdir.length > 0) {
              ...
              val broadcastSimiMap = docvec2Similarity(sc, docvec2eval, qid, qidTidnIdf(qid))
  ...
  /**
    ...
    * @return
    */
  private def docvec2Similarity(sc : SparkContext, docvectorfile : String, qid : Int = 0, qidTidnIdf: Map[Int, Double]) : Broadcast[Map[String, Double]] = {
    val cwidVector =
    ...
    val cwidcwidSimilarity: Map[String, Double] = cwidVector
      ...
      .map{case(x,y) =>(cwidPairKey(x._1._1, y._1._1),qcosineSimilarity(x._1._2, y._1._2, qidTidnIdf))}
      .collectAsMap()
      .toMap
...
/*  private def docvec2Similarity(sc : SparkContext, docvectorfile : String, dim : Int ) : Broadcast[Map[String, Double]] = {
  ...
  private def qcosineSimilarity(vec1: Array[String], vec2: Array[String], query: Map[Int, Double]) : Double = {
    ...
    val davgQuerySimilarity = normdavg match {
      case 0=> 0d
      case _=> dotproductDavgq / normdavg
    }
