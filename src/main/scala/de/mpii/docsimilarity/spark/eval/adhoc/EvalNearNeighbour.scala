...
object EvalNearNeighbour {
  ...
  def main(args : Array[String]): Unit = {
    ...
    val conf: SparkConf = new SparkConf()
      .setAppName("Eval on near-neighour benchmark " + expname)
    ...
    (101 to 300)
      ...
      .foreach(
        qid => {
          ...
          val cwidTopSimilarDocs = topkSimilarDocs(sc, qid, docvec2eval, bcqrel.value(qid), topks.max, parNum)
  ...
  /**
    ...
    * @return
    */
  private def topkSimilarDocs(sc : SparkContext, qid: Int, docvectorfile : String, cwidLabel: Map[String, Int], maxTopK: Int=50, parNum:Int=1024) :  RDD[(String, Array[(String, Double)])] = {
